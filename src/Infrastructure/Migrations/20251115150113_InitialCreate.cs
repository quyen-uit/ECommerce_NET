        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAdjustmentId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCollections_Collections_CollectionsId",
                        column: x => x.CollectionsId,
                        principalTable: "Collections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCollections_Products_ProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Item_ProductSkuId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryAdjustments_ProductSkus_ProductSkuId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryImports_ProductSkus_ProductSkuId",
                        column: x => x.ProductSkuId,
                        principalTable: "ProductSkus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryImports_Vendors_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryTransactions_ProductSkus_ProductSkuId",
                        column: x => x.ProductSkuId,
                        principalTable: "ProductSkus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreProductSkus", x => new { x.StoreId, x.ProductSkuId });
                    table.ForeignKey(
                        name: "FK_StoreProductSkus_ProductSkus_ProductSkuId",
                        column: x => x.ProductSkuId,
                        principalTable: "ProductSkus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StoreProductSkus_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnOrderItems_ProductSkus_ProductSkuId",
                        column: x => x.ProductSkuId,
                        principalTable: "ProductSkus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_ParentId_Order",
                table: "Categories",
                columns: new[] { "ParentId", "Order" },
                filter: "\"IsDeleted\" = false");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryAdjustments_ProductSkuId",
                table: "InventoryAdjustments",
                column: "ProductSkuId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryImports_ProductSkuId",
                table: "InventoryImports",
                column: "ProductSkuId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryImports_VendorId",
                table: "InventoryImports",
                column: "VendorId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_ProductSkuId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSkus_ColorId_SizeId",
                table: "ProductSkus",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreProductSkus_ProductSkuId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_ProductSkuId",
                table: "Wishlists",
                column: "ProductSkuId");
        }
